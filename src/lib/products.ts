export type Theme = "seafoam" | "powder" | "butter" | "blush";
...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    priceRange: "$60–$75",
    description:
      "Crisp powder tiers with anchor ribbon trim for a nautical-themed shower.",
  },
  {
    slug: "sweet-pea",
    name: "Sweet Pea",
    ...
    priceRange: "$60–$75",
    description:
      "Bright blush tiers wrapped in palm-green trim, topped with a tiny bow.",
  },
  {
    ...
    priceRange: "$110–$135",
    description:
      "Our tallest centerpiece: four generous tiers in seafoam and cream.",
    bestSeller: true,
  },
  {
    slug: "twin-joy",
  ...
  },
  {
    ...
    priceRange: "$65–$80",
    description:
      "Sunny butter tones with a sunscreen stick tucked into every tier.",
  },
  {
    ...
    priceRange: "$80–$100",
    description:
      "Coral and powder tiers with shimmer ribbon trim, styled for an under-the-sea shower.",
  },
  {
